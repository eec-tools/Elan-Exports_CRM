...
export const getAllComplianceDocs = async (_req: Request, res: Response) => {
  try {
...
// POST /api/compliance
export const createComplianceDoc = async (req: Request, res: Response) => {
  try {
...
export const updateComplianceDoc = async (req: Request, res: Response) => {
  try {
...
export const deleteComplianceDoc = async (req: Request, res: Response) => {
  try {
    const id = req.params.id as string;
