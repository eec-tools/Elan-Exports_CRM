...
import archivedBuyersRoutes from "./routes/archivedBuyers.routes.js";
import archivedSuppliersRoutes from "./routes/archivedSuppliers.routes.js";
...
app.use("/api/archived-buyers", archivedBuyersRoutes);
app.use("/api/archived-suppliers", archivedSuppliersRoutes);
