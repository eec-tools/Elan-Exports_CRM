...
router.post("/", requireEdit(["suppliers", "sourcing_suppliers"]), createFolder);
...
router.post("/:folderId/suppliers/send", requireEdit(["suppliers", "sourcing_suppliers"]), sendBulkEmail);
router.post("/:folderId/suppliers", requireEdit(["suppliers", "sourcing_suppliers"]), addToList);

router.delete("/:id", requireEdit(["suppliers", "sourcing_suppliers"]), deleteFolder);
