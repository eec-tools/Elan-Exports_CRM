...
export const getEmailTaskStats = async (req, res) => {
    try {
...
export const updateEmailTask = async (req, res) => {
...
export const deleteEmailTask = async (req, res) => {
    const id = req.params.id;
    try {
...
//# sourceMappingURL=emailTasks.controller.js.map