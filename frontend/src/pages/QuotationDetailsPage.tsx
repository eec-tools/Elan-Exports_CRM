...
export default function QuotationDetailsPage() {
  ...
  const canEdit =
    hasEditPermission("suppliers") || hasEditPermission("quotations");
  ...
  function toggleConfigSent(key: string, value: boolean) {
    setLocalConfig((prev) => ({
      ...
      [key]: {
        ...
        mandatory: value ? (prev[key]?.mandatory ?? false) : false,
      },
    }));
  }
    ...
    <div className="p-6 max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1 flex-wrap">
              <span
                className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${statusCfg.class}`}
              >
                {statusCfg.label}
              </span>
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem onClick={() => downloadPdf("supplier")}>
                <FileDown className="h-4 w-4 mr-2" /> Supplier View (sent fields
                only)
              </DropdownMenuItem>
                    ...
                    <div className="flex items-center gap-1.5 flex-wrap">
                      ...
                      {!sentToSupplier && (
                        <span className="inline-flex items-center gap-1 text-[10px] px-1.5 py-0.5 rounded bg-amber-50 text-amber-700 border border-amber-200">
                          <AlertTriangle className="h-2.5 w-2.5" /> Not sent to
                          supplier
                        </span>
                      )}
                      {filledBySupplier && (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-1 sm:col-span-2">
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    handleBuyerSpecChange("specs", e.target.value)
                  }
                  disabled={!canEdit}
                  className="text-sm resize-none"
                />
              ...
              <div className="space-y-1 sm:col-span-2">
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    handleBuyerSpecChange("notes", e.target.value)
                  }
                  disabled={!canEdit}
                  className="text-sm resize-none"
                />
            ...
            <div className="flex items-center justify-between">
              ...
              {canEdit && (
                <Button
                  size="sm"
                  variant="ghost"
                  className="gap-1.5 text-slate-500 h-7 text-xs"
                  onClick={() => {
      ...
      <Dialog open={configOpen} onOpenChange={setConfigOpen}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <DialogDescription>
            Update which fields appear in the supplier's web form. Regenerate
            the link after saving so the supplier sees the updated form.
          </DialogDescription>
            ...
            <table className="w-full text-sm">
              <thead className="bg-slate-50 border-b border-slate-200">
                <tr>
                  ...
                  <th className="px-3 py-2 text-xs font-semibold text-slate-500 text-center w-36">
                    Send to Supplier
                  </th>
                  <th className="px-3 py-2 text-xs font-semibold text-slate-500 text-center w-28">
                    Mandatory
                  </th>
                </tr>
              </thead>
      ...
      <Dialog open={formLinkDialog} onOpenChange={setFormLinkDialog}>
        <DialogContent className="max-w-md">
          ...
          <DialogDescription>
            Share this updated link with{" "}
            <strong>{quotation.supplierName}</strong> for the next negotiation
            round.
          </DialogDescription>
