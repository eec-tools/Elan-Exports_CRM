            ...
            <div><p className="text-xs font-semibold uppercase tracking-wider text-slate-400 mb-3">Documents & Remarks</p>
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-col gap-2">
                    <input type="file" accept=".png,.jpg,.jpeg,.webp,.jfif" multiple className="hidden" id="multi-catalog-img-upload" onChange={(e) => { if (e.target.files) setCatalogImageFiles((prev) => [...prev, ...Array.from(e.target.files || [])]); }} />
