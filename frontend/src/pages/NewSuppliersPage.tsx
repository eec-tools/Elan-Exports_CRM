                ...
                <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto p-6 bg-white rounded-xl shadow-2xl border-none custom-scrollbar-light">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6 mt-4">
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-col gap-2">
                                        <input type="file" accept=".pdf,.png,.jpg,.jpeg,.jfif" multiple className="hidden" id="multi-cert-upload-ns" onChange={(e) => { if (e.target.files) setCertificateFiles((prev) => [...prev, ...Array.from(e.target.files || [])]); }} />
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-col gap-2">
                                        <input type="file" accept=".png,.jpg,.jpeg,.jfif" multiple className="hidden" id="multi-photo-upload-ns" onChange={(e) => { if (e.target.files) setWarehousePhotoFiles((prev) => [...prev, ...Array.from(e.target.files || [])]); }} />
                        ...
                        <div>
                            ...
                            <div className="flex flex-col gap-2">
                                <input type="file" accept=".pdf,.doc,.docx,.png,.jpg,.jpeg,.jfif" multiple className="hidden" id="multi-quotation-upload-ns" onChange={(e) => { if (e.target.files) setQuotationFiles((prev) => [...prev, ...Array.from(e.target.files || [])]); }} />
                                <Button type="button" variant="outline" size="sm" className="gap-2 text-slate-600 border-slate-200 w-fit" onClick={() => document.getElementById("multi-quotation-upload-ns")?.click()}>
